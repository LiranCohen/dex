...
describe('Icon', () => {
  ...
  it('applies small size', () => {
    ...
    expect(svg).toHaveClass('v2-icon--sm');
  });
  ...
  it('applies medium size by default', () => {
    ...
    expect(svg).toHaveClass('v2-icon--md');
  });
  ...
  it('applies large size', () => {
    ...
    expect(svg).toHaveClass('v2-icon--lg');
  });
  ...
  it('applies spinning class to spinner icon', () => {
    ...
    const svg = container.querySelector('svg');
    expect(svg).toHaveClass('v2-icon--spinning');
  });

  it('does not apply spinning class to non-spinner icons', () => {
    const { container } = render(<Icon name="check" />);
    const svg = container.querySelector('svg');
    expect(svg).not.toHaveClass('v2-icon--spinning');
  });
  ...
  it('applies custom className', () => {
    ...
    expect(svg).toHaveClass('v2-icon');
  });
