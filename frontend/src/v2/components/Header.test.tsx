...
describe('Header', () => {
  ...
  it('renders back link when provided', () => {
    render(<Header backLink={{ to: '/v2/quests', label: 'Quests' }} />);
  ...
  it('does not show inbox badge when count is 0', () => {
    ...
    expect(container.querySelector('.v2-header__inbox-badge')).not.toBeInTheDocument();
  });
  ...
  describe('mobile menu', () => {
    ...
    it('mobile navigation has correct aria-hidden when menu is closed', () => {
      ...
      const mobileNav = container.querySelector('.v2-header__mobile-menu');
      // When closed, the menu should not have the open class
      expect(mobileNav).not.toHaveClass('v2-header__mobile-menu--open');
    });
    ...
    it('closes menu when overlay is clicked', async () => {
      ...
      const overlay = container.querySelector('.v2-header__menu-overlay');
    ...
    it('shows inbox badge on hamburger when menu closed and count > 0', () => {
      ...
      const menuBadge = container.querySelector('.v2-header__menu-badge');
    ...
    it('closes menu when mobile link is clicked', async () => {
      ...
      const mobileHomeLink = mobileLinks.find(link =>
        link.closest('.v2-header__mobile-menu')
      );
    ...
    it('applies open class to hamburger when menu is open', async () => {
      ...
      const hamburger = container.querySelector('.v2-header__hamburger');
      expect(hamburger).toHaveClass('v2-header__hamburger--open');
    });
