    ...
    >
      ...
      >
        <div className="app-modal__header">
          <h2 id="shortcuts-title" className="app-modal__title">Keyboard Shortcuts</h2>
          <button
            ref={closeButtonRef}
            type="button"
        ...
        <div className="app-modal__content">
          {shortcuts.map((section) => (
            <div key={section.category} className="app-shortcuts-section">
              <h3 className="app-shortcuts-section__title">{section.category}</h3>
              <div className="app-shortcuts-list" role="list">
                {section.items.map((item) => (
                  <div key={item.keys} className="app-shortcut" role="listitem">
                    <kbd className="app-shortcut__keys">{item.keys}</kbd>
                    <span className="app-shortcut__desc">{item.description}</span>
                  </div>
                ))}
              </div>
            </div>
