...
describe('Message', () => {
  ...
  describe('message status', () => {
    it('applies error class for error status', () => {
      ...
      expect(container.querySelector('.app-message--error')).toBeInTheDocument();
    });
  ...
  describe('streaming state', () => {
    it('applies streaming class', () => {
      ...
      expect(container.querySelector('.app-message--streaming')).toBeInTheDocument();
    });
    ...
    it('shows cursor during streaming', () => {
      ...
      expect(container.querySelector('.app-cursor')).toBeInTheDocument();
    });
    ...
    it('hides cursor when not streaming', () => {
      ...
      expect(container.querySelector('.app-cursor')).not.toBeInTheDocument();
    });
  });
  ...
  describe('tool calls', () => {
    ...
    it('shows spinner for running tools', () => {
      ...
      expect(container.querySelector('.app-tool-activity__spinner')).toBeInTheDocument();
    });
  ...
  describe('copy functionality', () => {
    it('shows copy button on hover for assistant messages', () => {
      ...
      const message = container.querySelector('.app-message')!;
      fireEvent.mouseEnter(message);

      const copyButton = screen.getByLabelText('Copy message to clipboard');
      expect(copyButton).toHaveClass('app-message__action--visible');
    });
    ...
    it('hides copy button on mouse leave', () => {
      ...
      expect(copyButton).not.toHaveClass('app-message__action--visible');
    });
  ...
  it('applies sender class', () => {
    ...
    expect(container.querySelector('.app-message--user')).toBeInTheDocument();
  });
});
